...
import schemas from '../Utils/swagger-schema';
          ...
          servers: [
            {
              ...
              variables: {
                protocol: {
                  enum: ['http', 'https'],
                  default:
                    process.env.UP_STAGE === 'localhost' ? 'http' : 'https',
                },
              },
            },
          ],
...
function generateHTML(
  ...
  customfavIcon =
    customfavIcon ||
    'https://ampup-public-assets.s3-us-west-2.amazonaws.com/ico/favicon.png';
...
function swaggerAssetMiddleware(options) {
  try {
    ...
    consoleLog('[Error] - swaggerAssetMiddleware', error.message);
  }
}
